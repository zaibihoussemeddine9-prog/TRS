...
export async function POST(req: NextRequest) {
  try {
    ...
    const { code, name, family, form, dosage, unitsPerPack, nominalSpeed, targetOEE, targetRejectRate, standardLotSize, formatChangeTime, cleaningTime, comments, active, userId } = body;
    ...
    const product = await prisma.product.create({
      data: {
        name, code,
        family: family || null, form: form || null, dosage: dosage || null,
...
export async function PUT(req: NextRequest) {
  try {
    const body = await req.json();
    const { id, code, name, family, form, dosage, unitsPerPack, nominalSpeed, targetOEE, targetRejectRate, standardLotSize, formatChangeTime, cleaningTime, comments, active, userId } = body;

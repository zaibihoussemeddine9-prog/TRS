  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <div className="w-48"><Select options={lines} placeholder="Toutes les lignes" value={filterLine} onChange={(e) => setFilterLine(e.target.value)} /></div>
        <div className="w-48"><Select options={products} placeholder="Tous les produits" value={filterProduct} onChange={(e) => setFilterProduct(e.target.value)} /></div>
